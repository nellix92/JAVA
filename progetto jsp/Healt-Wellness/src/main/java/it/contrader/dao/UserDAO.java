...
public class UserDAO implements DAO<User> {
    ...
    private final String QUERY_CREATE = "INSERT INTO utenti (username, password, usertype) VALUES (?,?,?)";
    ...
    public boolean insert(User userToInsert) {
        ...
        try {
            ...
            preparedStatement.setString(3, String.valueOf(userToInsert.getUsertype()));
    ...
    public boolean update(User userToUpdate) {
        ...
        if (!userRead.equals(userToUpdate)) {
            try {
                ...
                preparedStatement.setString(3, userToUpdate.getUsertype().name());
