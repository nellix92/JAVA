...
public class UserDAO {
	...
	private final String QUERY_CREATE = "INSERT INTO utenti (username, password, user_role) VALUES (?,?,?)";
	private final String QUERY_READ = "SELECT * FROM utenti WHERE id=?";
	private final String QUERY_FINDID = "SELECT id FROM utenti WHERE username=?";
	private final String QUERY_UPDATE = "UPDATE utenti SET username=?, password=?, user_role=? WHERE id=?";
	...
	public List<User> getAll() {
		...
		try {
			...
			while (resultSet.next()) {
				...
				String usertype = resultSet.getString("user_role");
	...
	public User read(int userId) {
		...
		try {
			...
			usertype = resultSet.getString("user_role");
	...
	public int findId(String username){
		Connection connection = ConnectionSingleton.getInstance();
		try{
			PreparedStatement preparedStatement = connection.prepareStatement(QUERY_FINDID);
